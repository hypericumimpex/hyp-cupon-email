    ...
    public function output( $option ) {
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-checkbox">
                ...
                <button type="button" class="button-secondary ywces-purge-coupon"><?php _e( 'Delete expired coupons', 'yith-woocommerce-coupon-email-system' ); ?></button>
                <div class="ywces-clear-result clear-progress"><?php _e( 'Deleting expired coupons...', 'yith-woocommerce-coupon-email-system' ); ?></div>
            </td>
        </tr>
        <?php
    }
